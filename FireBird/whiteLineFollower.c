/** @file: whiteLineFollower.c
 * Module for white line following, checkpoint detection and synchronization
 */
...
/** Interrupt handler for left position encoder */
 void lPosHandler() {
	lPosCount ++;
 }

/** Interrupt handler for right position encoder */
 void rPosHandler() {
  	rPosCount ++;
 }

/** Returns number of `ticks' generated by position encoder when bot moves
 * specified distance (in millimeters). */
...
/** Initialize white line follower module */
